        ...
        // +----------------------------------------------------------+
            ...
            // +------------------------------------------------------+  
                ...
                // +--------------------------------------------------+  
                    ...
                    con_hops_destroy(objs->con_echo_mics_object);
        ...
        // +----------------------------------------------------------+
            ...
            // +------------------------------------------------------+ 
                ...
                // +--------------------------------------------------+
                    ...
                    objs->acon_echo_mics_object = acon_hops_construct(1, objs->nMessages, cfgs->msg_hops_mics_rs_config);
            ...
            // +------------------------------------------------------+  
                ...
                // +--------------------------------------------------+  
                    ...
                    amod_stft_connect(objs->amod_stft_mics_object, 
                                      objs->acon_echo_mics_object->outs[0], 
        ...
        // +----------------------------------------------------------+
            ...
            // +------------------------------------------------------+  
                ...
                // +--------------------------------------------------+  
                    ...
                    acon_hops_destroy(objs->acon_echo_mics_object);
