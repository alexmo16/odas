    ...
    void threads_multiple_start(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // | Module                                               |
            // +------------------------------------------------------+  
                thread_start(aobjs->amod_echo_mics_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+                     
                thread_start(aobjs->acon_echo_mics_object->thread);
    ...
    void threads_multiple_join(aobjects * aobjs) {
        ...
        // +----------------------------------------------------------+  
            ...
            // +------------------------------------------------------+  
                ...
                thread_join(aobjs->amod_echo_mics_object->thread);

            // +------------------------------------------------------+
            // | Connector                                            |
            // +------------------------------------------------------+  

                thread_join(aobjs->acon_echo_mics_object->thread);
        ...
        // +-----------------------------------------------------------
            ...
            // +------------------------------------------------------+  
                ...
                // +--------------------------------------------------+  
                    ...
                    begin = clock();
                    mod_echo_process(objs->mod_echo_mics_object);
                    end = clock();
                    prf->mod_echo_mics_prf += (float) (((double) (end-begin)) / CLOCKS_PER_SEC);
